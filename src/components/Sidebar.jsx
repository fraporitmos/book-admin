    ...
    <div className="flex h-screen w-64 flex-col justify-between  z-40 border-e bg-gray-800">
      <div className="px-4 py-6">
        <div className="flex justify-center w-full items-center">
          <img
            src={Libro}
            className=" h-18 w-18 object-cover  rounded-full bg-gray-900 text-gray-600 "
          />
        </div>
        ...
        <ul className="mt-6 space-y-1">
          <li>
            ...
            >
              <div
                href="#"
                className={`flex items-center rounded-lg duration-300 ease-in-out  cursor-pointer px-4 py-2   ${
          ...
          <li>
            ...
            >
              <div
                href="#"
                className={`flex items-center  rounded-lg  duration-500 ease-in-out  cursor-pointer px-4 py-2 ${
